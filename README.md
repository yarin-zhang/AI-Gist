...
| 平台 | 安装包 | 应用市场 | 说明 |
|------|----------|----------|------|
| ![Windows](https://custom-icon-badges.demolab.com/badge/Windows-0078D6?logo=windows11&logoColor=white) | [Windows Setup](https://apps.microsoft.com/detail/9n6vb23vsk8k?hl=zh-CN&gl=US) |  | Windows 安装程序 |
