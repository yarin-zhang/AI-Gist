export default {
  ...
  promptManagement: {
    ...
    manualAdjustmentPlaceholder: 'Please enter adjustment instruction',
    manualAdjustmentTip: 'You can enter natural language instructions to fine-tune the prompt',
    cancelAdjustment: 'Cancel',
    confirmAdjustment: 'Confirm Adjustment',
    aiModelPlaceholder: 'Please select AI model',
    ...
    historyDescription: 'View and rollback history versions',
    update: 'Update',
    create: 'Create',
    tags: 'Tags',
    category: 'Category',
