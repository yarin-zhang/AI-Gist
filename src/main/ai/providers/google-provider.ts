...
export class GoogleProvider extends BaseAIProvider {
  ...
  async testConfig(config: AIConfig): Promise<AITestResult> {
    console.log(`测试 Google 连接，使用 baseURL: ${config.baseURL}`);
    ...
    try {
      ...
      console.log(`Google 连接测试成功，获取到模型:`, models);
